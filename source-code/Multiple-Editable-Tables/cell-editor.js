...
const editableTableOne   = new EditableTable(1, 1);
const editableTableTwo   = new EditableTable(2, 2);
const editableTableThree = new EditableTable(3, 3);
const editableTableFour  = new EditableTable(4, 4);
const editableTableFive  = new EditableTable(5, 5);
const editableTableSix   = new EditableTable(6, 6);
